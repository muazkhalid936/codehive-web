  ...
  return (
    <div className="h-[60vh] md:h-[400px] xl:h-[500px] flex  text-white flex-col md:flex-row gap-10 my-auto w-[90%] rounded-3xl overflow-hidden p-5 relative ">
      <div className="absolute top-0 left-0 w-full h-full ">
        <img src={bg} alt="1" className="w-full z-10 h-full object-cover " />
      </div>
      <div className="w-full z-20 md:w-1/2  gap-10 flex md:px-4 md:py-2 flex-col justify-center md:justify-start items-center md:items-start">
        <div className="w-full">
          <h1 className="text-yellow-400  main-heading font-bold text-start text-6xl">
            {num}
          </h1>
        </div>
        <div>
          <h1 className="bg-gradient-to-r main-heading from-white  via-blue-500 to-blue-500 font-extrabold bg-clip-text text-transparent text-2xl md:text-3xl xl:text-6xl">
            {heading}
          </h1>
        </div>
