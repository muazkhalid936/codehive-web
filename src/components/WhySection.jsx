...
const WhySection = () => {
  ...
  return (
    ...
    // </div>
    <>
      <div ref={main}  className="container h-screen mb-20 font-extrabold  mx-auto flex flex-col justify-center items-center text-2xl md:text-5xl text-white md:space-y-16">
