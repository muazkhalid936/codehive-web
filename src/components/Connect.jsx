      ...
      <div>
        <form className=" mx-auto py-10 flex-col xl:px-32 rounded-[25px]  w-[90%] bg-gradient-to-br p-5  from-[#051e32] to-[#021322]">
          <div className="flex flex-col gap-2">
            <p className="text-white mx-auto xl:text-4xl font-extrabold">
              Let's Talk
            </p>
            <div className="flex mx-auto text-white gap-2 xl:gap-5 ">
              {" "}
              <h1 className="header text-blue-400 text-2xl md:text-4xl lg:text-6xl xl:text-7xl">
                {" "}
                Connect{" "}
              </h1>
              <h1 className="header text-2xl md:text-4xl lg:text-6xl xl:text-7xl">
                with us
              </h1>
            </div>
          </div>
